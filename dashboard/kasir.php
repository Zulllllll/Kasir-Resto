...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="transaksi/transaksi.php" class="d-block text-white mb-3">
            <i class="mdi mdi-receipt-text-outline"></i> Entri Transaksi 
        </a>
            ...
            <div class="col-md-6 d-flex justify-content-center">
                <div class="card shadow-sm" style="width: 100%; max-width: 500px; height: 300px;">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center text-center">
                        <h5 class="card-title mb-3"><i class="mdi mdi-receipt-text-outline"></i>Lihat Transaksi</h5>
                        <p class="card-text mb-4" style="font-size: 16px;">Kelola Riwayat Transaksi Pelanggan.</p>
                        <a href="transaksi/transaksi.php" class="btn btn-primary">Lihat</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 d-flex justify-content-center">
                <div class="card shadow-sm" style="width: 100%; max-width: 500px; height: 300px;">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center text-center">
                        <h5 class="card-title mb-3"><i class="mdi mdi-chart-line"></i>Lihat Laporan</h5>
                        <p class="card-text mb-4" style="font-size: 16px;">Kelola Laporan Transaksi Pelanggan.</p>
